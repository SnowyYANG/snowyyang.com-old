...
<b id="a9">后日谈</b>
可惜我(们)到底还是太天真。
2019年夏秋冬，一场异常规模的混乱场袭击了我所在的城市。
混乱中，我开始胡思乱想，大脑开始再次难受，最终被确诊为躁郁症，预定用药五年。
在躁狂发作的时候，我甚至还谈了一次恋爱。
虽然等到躁狂结束我很快分手了，但一想到疾病就这样轻易地动摇了自己十几年来深深的信仰，我还是非常恐惧。
几年没见到风君，曾经和他的一切开始变得不真实，有时我也在想他的存在是不是自己的臆想。
真实的是，我每个月都要注射药剂。
混乱场依然遗留在我所在的城市，我最终选择离开，在一个消费低的小城市找了一份一般薪水的简单工作隐居。
有的时候，觉得自己很弱，打不过混乱场。
也不知道该怎样变强，也仍然不想结婚，只是带着不再发病的祈愿，一个人安安静静地活在这个世上。
TEXT;
$timestamp = date('Y年n月j日H:i:s', filemtime(__FILE__));
echo "<h1>$title</h1><p style=\"max-width:50em\">（已完结 最后修改于${timestamp}）<br>";
$lines = explode("\n",$text);
foreach($lines as $l) {
	echo $l;
	echo '<br>';
