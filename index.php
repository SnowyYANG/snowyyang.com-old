...
<html>
    ...
    <body style="margin:0;font:16px Microsoft YaHei;">
        ...
        <div style="width: 3em; position: fixed; top:0; right:0; background: #eaf4fc; padding: 1em; height: 100%;">
          <footer style="position:absolute; left:1em; bottom:8em; color:#ffffff; white-space:nowrap; transform-origin:left center 0; transform:rotate(90deg)">皖ICP备2022001590号-1 Snowy❄&#65038;2022</footer>
        </div>
    </body>
</html>
